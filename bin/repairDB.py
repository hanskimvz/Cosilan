...
# print(x)
    ...
    # a = os.popen("mysqladmin shutdown -uroot -prootpass")
    # p = a.read()
    # print (p)
    # time.sleep(2)
    # shutil.copy(_ROOT_DIR + "/Mariadb/ibdata1.%s" %bk_str, _ROOT_DIR + "/Mariadb/data/ibdata1")
    # time.sleep(2)

    # os.chdir(_ROOT_DIR + "/MariaDB/bin")
    # a = os.popen("start mysqld.exe")	
    # p = a.read()
    # print (p)        
