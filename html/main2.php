...
//################################# SIDE MENU ########################################
require_once $_SERVER['DOCUMENT_ROOT']."/inc/pageSide.php";
			...
			<div class="card flex-fill">
				...
				<div class="card-body my-2">
					<div class="row d-flex align-items-center mb-4">
						...
						<div class="col-4 text-right"><span id="card[0][percent]" class="text-muted">100%</span></div></div>
					<div class="progress progress-sm shadow-sm mb-1">
						<div id="card[0][progress]" class="progress-bar" role="progressbar" style="width:100%; background-color:#47bac1"></div></div>
				</div>
			</div>
		</div>
		<div class="col-sm-6 col-md-3">			
			<div class="card flex-fill">
				...
				<div class="card-body my-2">
					<div class="row d-flex align-items-center mb-4">
						...
						<div class="col-4 text-right"><span id="card[2][percent]" class="text-muted">100%</span></div></div>
					<div class="progress progress-sm shadow-sm mb-1">
						<div id="card[2][progress]"class="progress-bar" role="progressbar" style="width:100%; background-color:#5b7dff"></div></div>
				</div>
			</div>
		</div>
		<div class="col-sm-6 col-md-3">
			<div class="card flex-fill">
				<div class="card-header">
					...
					<h5 id="card[1][title]" class="card-title mb-0">$msg[yesterday]</h5></div>
				<div class="card-body my-2">
					<div class="row d-flex align-items-center mb-4">
						<div class="col-8"><h2 id="card[1][value]" class="d-flex align-items-center mb-0 font-weight-light">0</h2></div>
						<div class="col-4 text-right"><span id="card[1][percent]" class="text-muted">100%</span></div></div>
					<div class="progress progress-sm shadow-sm mb-1">
						<div id="card[1][progress]" class="progress-bar" role="progressbar" style="width:100%; background-color:#fcc100"></div></div>
				</div>
			</div>
		</div>
		<div class="col-sm-6 col-md-3">
			<div class="card flex-fill">
				<div class="card-header">
					...
					<h5 id="card[3][title]" class="card-title mb-0">$msg[total12weeks]</h5></div>
				<div class="card-body my-2">
					<div class="row d-flex align-items-center mb-4">
						<div class="col-8"><h2 id="card[3][value]" class="d-flex align-items-center mb-0 font-weight-light">0</h2></div>
						<div class="col-4 text-right"><span id="card[3][percent]"class="text-muted">100%</span></div></div>
					<div class="progress progress-sm shadow-sm mb-1">
						<div id="card[3][progress]" class="progress-bar" role="progressbar" style="width:100%; background-color:#5fc27e"></div></div>
				</div>
			</div>
		</div>					
...
EOBLOCK;
	...
	<div class="col-lg-12 col-xl-12">
		<div class="card flex-fill w-100 d-flex">
			<div class="card-header"><h5 class="card-title mb-0">$th_json[display]</h5></div>
			<div class="card-body  p-2">
