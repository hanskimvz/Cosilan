				...
				<div class="col-lg-6 col-xl-5">
					<div class="row w-100">
						<div class="col-sm-6">
							<div class="card flex-fill">
								<div class="card-header">
									<span class="badge float-right" style="background-color:#47bac1">$msg[visitors]</span>
									<h5 class="card-title mb-0">$msg[today]</h5></div>
								<div class="card-body my-2">
									<div class="row d-flex align-items-center mb-4">
										<div class="col-8">
											<h2 id="card[0][value]" class="d-flex align-items-center mb-0 font-weight-light">0</h2>
										</div>
										<div class="col-4 text-right">
											<span id="card[0][percent]" class="text-muted">100%</span>
										</div>
									</div>
							...
							<div class="card flex-fill">
								<div class="card-header">
									<span class="badge float-right" style="background-color:#5b7dff">$msg[visitors]</span>
									<h5 class="card-title mb-0">$msg[average12weeks]</h5></div>
								<div class="card-body my-2">
									<div class="row d-flex align-items-center mb-4">
										<div class="col-8">
											<h2 id="card[1][value]" class="d-flex align-items-center mb-0 font-weight-light">0</h2>
										</div>
										<div class="col-4 text-right">
											<span id="card[1][percent]" class="text-muted">100%</span>
										</div>
									</div>
									<div class="progress progress-sm shadow-sm mb-1">
										<div id="card[1][progress]"class="progress-bar" role="progressbar" style="width:100%; background-color:#5b7dff"></div>
									</div>
								</div>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="card flex-fill">
								<div class="card-header">
									<span class="badge float-right" style="background-color:#fcc100">$msg[visitors]</span>
									<h5 class="card-title mb-0">$msg[yesterday]</h5>
								</div>
								<div class="card-body my-2">
									<div class="row d-flex align-items-center mb-4">
										<div class="col-8">
											<h2 id="card[2][value]" class="d-flex align-items-center mb-0 font-weight-light">0</h2>
										</div>
										<div class="col-4 text-right">
											<span id="card[2][percent]" class="text-muted">100%</span>
										</div>
									</div>
									<div class="progress progress-sm shadow-sm mb-1">
										<div id="card[2][progress]" class="progress-bar" role="progressbar" style="width:100%; background-color:#fcc100"></div>
									</div>
								</div>
							</div>
							<div class="card flex-fill">
								<div class="card-header">
									<span class="badge float-right" style="background-color:#5fc27e">$msg[visitors]</span>
									<h5 class="card-title mb-0">$msg[total12weeks]</h5>
								</div>
								<div class="card-body my-2">
									<div class="row d-flex align-items-center mb-4">
										<div class="col-8">
											<h2 id="card[3][value]" class="d-flex align-items-center mb-0 font-weight-light">0</h2>
										</div>
										<div class="col-4 text-right">
											<span id="card[3][percent]"class="text-muted">100%</span>
										</div>
									</div>
									<div class="progress progress-sm shadow-sm mb-1">
...
EOPAGE;
	...
	$nav_top_left = '
		<div class="form-inline d-none d-sm-inline-block">
			...
			<select class="form-control mr-sm-2" id="store" OnChange="changeStore(0);"><option value="0">'.$msg['allstore'].'</option></select>
			<span class="ml-3"></span>
			<button class="form-control mr-sm-1" id="10min"  OnClick="changeViewBy(\'10min\');">'.$msg['by10min'].'</button>
...
//	$JS_FOOT = '<script src="js/dataGlunt.js"></script>';
	$pageContents = <<<EOPAGE
	<main class="content">
		<div class="container-fluid p-0">
			<div class="row">
				<div class="col-12 col-lg-12">
					<div class="card flex-fill">
						<div class="card-body w-100"><!--canvas id="footfallChart"--></canvas><div id="chart_curve"></div></div>
					</div>
				</div>
			</div>
			<div class="row">
...
//	$JS_FOOT = '<script src="js/latestFlow.js"></script>';
	$pageContents = <<<EOPAGE
	<main class="content">
		<div class="container-fluid p-0">
			<div class="row">
...
EOPAGE;
	...
	$nav_top_left = '
		<div class="form-inline d-none d-sm-inline-block">
			...
			<span class="ml-3"></span>
			<button class="form-control mr-sm-2" id="10min" OnClick="changeViewBy(\'10min\');">'.$msg['by10min'].'</button>
			<button class="form-control mr-sm-2" id="hour" OnClick="changeViewBy(\'hour\');" style="background-color:#fcc100;">'.$msg['byhour'].'</button>
			<button class="form-control mr-sm-2" id="day" OnClick="changeViewBy(\'day\');">'.$msg['byday'].'</button>
			<span class="ml-3"></span>
			<span class="ml-2" id="date_additional" style="display:none">
				<span type="button" class="form-control" OnClick="changeDate(-2);"><i class="fa fa-chevron-left"></i></span>
				<input type="text" class="form-control form-control-no-border mr-sm-6 text-center" name="refdate_from" id="refdate_from" size="10" OnChange="changeDate(0)">
...
//	$JS_FOOT = '<script src="js/trendAnalysis.js"></script>';
	$pageContents = <<<EOPAGE
	<main class="content">
		<div class="container-fluid p-0">
			<div class="row">
				...
				<div class="col-12 col-lg-4">
					<div class="card">
						...
						<div class="card-body w-100 d-flex" align="center">
							<div class="chart"><div id="ageBGraph" height="160px"></div></div>
						</div>				
					</div>
				</div>				
			</div>
	...
	<main class="content">
		<div class="container-fluid p-0">
			<div class="row">
				...
				<input type="hidden" id="code" value="$arr_result[code]">	
				<input type="hidden" id="server_address" value="$_SERVER[HTTP_HOST]">

				<div class="col-12 col-lg-4">
					<div class="card">
						<div class="card-header">
							<h5 class="card-title mb-0">$msg[place]</h5>
						</div>
						<div class="card-body">
							<div class="form-group">
								<label class="col-form-label">$msg[square]</label>
								<div id="square_pad"></div>
							</div>
							<div class="form-group">
								<label class="col-form-label">$msg[store]</label>
								<div id="store_pad"></div>
							</div>
							<!--div class="form-group">
								<label class="col-form-label">$msg[camera]</label>
								<div id="camera_pad"></div>
							</div-->
						</div>
					</div>
				</div>
				<div class="col-12 col-lg-4">
					<div class="card">
						...
						<div class="card-body">
							<div class="form-group">
								<label class="col-form-label">$msg[label]</label>
								<label class="custom-control custom-checkbox">
									<input id="label_entrance" type="checkbox" class="custom-control-input" OnChange="setConfig();" checked>
									<span class="custom-control-label">$msg[entrance]</span>
								</label>
								<label class="custom-control custom-checkbox">
									<input id="label_exit" type="checkbox" class="custom-control-input" OnChange="setConfig();">
									<span class="custom-control-label">$msg[exit]</span>
								</label>
								<label class="custom-control custom-checkbox">
									<input id="label_outside" type="checkbox" class="custom-control-input" OnChange="setConfig();">
									<span class="custom-control-label">$msg[outside]</span>
								</label>
								<label class="custom-control custom-checkbox">
									<input id="label_none" type="checkbox" class="custom-control-input" OnChange="setConfig();">
									<span class="custom-control-label">$msg[none]</span>
								</label>
							</div>
							<div class="form-group">
								<label class="col-form-label">$msg[groupby]</label>
								<label class="custom-control custom-radio">
									<input name="groupby" id="group_none" type="radio" class="custom-control-input" OnChange="setConfig();" checked>
									<span class="custom-control-label">$msg[nogroup]</span>
								</label>
								<label class="custom-control custom-radio">
									<input name="groupby" id="group_square" type="radio" class="custom-control-input" OnChange="setConfig();">
									<span class="custom-control-label">$msg[square]</span>
								</label>
								<label class="custom-control custom-radio">
									<input name="groupby" id="group_store"type="radio" class="custom-control-input" OnChange="setConfig();">
									<span class="custom-control-label">$msg[store]</span>
								</label>
								<label class="custom-control custom-radio">
									<input name="groupby" id="group_camera" type="radio" class="custom-control-input" OnChange="setConfig();">
									<span class="custom-control-label">$msg[camera]</span>
								</label>
							</div>	
							<div class="form-group">
								<label class="col-form-label">$msg[apikey]</label>
				...
				<div class="col-12 col-lg-4">
					<div class="card">
						...
						<div class="card-body">
							<div class="form=group">
								<label class="col-form-label">$msg[dateandtime]</label>
								<div class="form-group form-inline">
									<input type="text" class="form-control text-center" id="refdate_from" size="12" OnChange="setConfig();">
									<span class="ml-2 mr-2">~</span>
									<input type="text" class="form-control text-center" id="refdate" size="12" OnChange="setConfig();">
								</div>
							</div>
							<div class="form-group">
								<label class="col-form-label">$msg[timetable]</label>
								<label class="custom-control custom-radio ml-2">
									<input name="interval" id="interval_tenmin" type="radio" class="custom-control-input" OnChange="setConfig();">
									<span class="custom-control-label">$msg[tenmin]</span>
								</label>
								<label class="custom-control custom-radio ml-2">
									<input name="interval" id="interval_hourly" type="radio" class="custom-control-input" OnChange="setConfig();">
									<span class="custom-control-label">$msg[hourly]</span>
								</label>
								<label class="custom-control custom-radio ml-2">
									<input name="interval" id="interval_daily" type="radio" class="custom-control-input" OnChange="setConfig();" checked>
									<span class="custom-control-label">$msg[daily]</span>
								</label>
								<label class="custom-control custom-radio ml-2">
									<input name="interval" id="interval_weekly" type="radio" class="custom-control-input" OnChange="setConfig();">
									<span class="custom-control-label">$msg[weekly]</span>
								</label>
								<label class="custom-control custom-radio ml-2">
									<input name="interval" id="interval_monthly" type="radio" class="custom-control-input" OnChange="setConfig();">
									<span class="custom-control-label">$msg[monthly]</span>
								</label>
							</div>
							<div class="form-group">
								<label class="col-form-label">$msg[format]</label>
								<div class="form-group form-inline">
									<label class="custom-control custom-radio ml-3">
										<input name="output_table" id="output_table" type="radio" class="custom-control-input" OnChange="setConfig();" checked>
										<span class="custom-control-label">$msg[table]</span>
									</label>
									<label class="custom-control custom-radio ml-3">
										<input name="output_table" id="output_csv" type="radio" class="custom-control-input" OnChange="setConfig();">
										<span class="custom-control-label">$msg[csv]</span>
									</label>
									<label class="custom-control custom-radio ml-3">
										<input name="output_table" id="output_json" type="radio" class="custom-control-input" OnChange="setConfig();">
										<span class="custom-control-label">$msg[json]</span>
									</label>
									<label class="custom-control custom-radio ml-3">
										<input name="output_table" id="output_curve" type="radio" class="custom-control-input" OnChange="setConfig();">
							...
							<div class="form-group">
								<label class="col-form-label">$msg[order]</label>
								<div class="form-group form-inline">
									<label class="custom-control custom-radio ml-3">
										<input name="order" id="order_asc" type="radio" class="custom-control-input" OnChange="setConfig();" checked>
										<span class="custom-control-label">$msg[asc]</span>
									</label>
									<label class="custom-control custom-radio ml-3">
										<input name="order" id="order_desc" type="radio" class="custom-control-input" OnChange="setConfig();">
				...
				<div class="col-12 col-lg-12">
					<div class="form-group">
					<label class="col-form-label">$msg[api]</label>
						<textarea id="query_api" class="form-control" >$query_api</textarea>
					</div>
				</div>
				<div class="col-12 col-lg-12">
					<div class="form-group text-center">
					<button type="button" class="btn btn-primary" name='btn' value='query' id="query" onClick= "QueryAPI();">$msg[query]</button>
					<!--button type="button" class="btn btn-primary" name='btn' value='query'>$msg[query]</button-->
				</div>
				</div>
					</div>
				</div>
		...
		<div class="modal fade" id="modalSnapshot" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="modal-dialog modal-xl" role="document">
				<div class="modal-content">
					...
					<div class="text-center" id="snapShot"></div>
					</div>
				</div>
			</div>
		</div>		
	...
	<main class="content">
		<div class="container-fluid p-0">
			...
			<div class="row">
				<div class="col-12 col-lg-12">
					<div class="card flex-fill">
					<div class="card-body w-100">$TABLE_BODY</div>
					</div>
				</div>		
			</div>
		</div>
